...
<head>
  ...
  <title>Admin Sistem Tabungan Siswa | Data Admin</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- SEARCH FORM -->
   <form class="form-inline ml-3" method="get" action="/admin/dataadmincari" enctype="multipart/form-data">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- Data Anggota -->
          <li class="nav-item">
            <a href="/admin/dataadmin" class="nav-link active">
  ...
  <!-- Content Wrapper. Contains page content -->
   <div class="content-wrapper">
     ...
     <section class="content">
       <div class="container-fluid">
       <a href="/register" class="btn btn-danger">Tambah Admin</a>
       </br></br>
       <div class="card">
               ...
               <tbody>
                 ...
                 <tr>
                   ...
                   <td>{{ $ang->email }}</td>
                   <td>
                     <a href="/admin/dataadmin/hapus/{{ $ang->id }}" class="btn btn-danger" style="width:100%;">Hapus</a>
                   </td>
                 </tr>
                 @endforeach
               </tbody>
