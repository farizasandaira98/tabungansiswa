...
<head>
  ...
  <title>Admin Sistem Tabungan Siswa | Data Siswa</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- SEARCH FORM -->
   <form class="form-inline ml-3" method="get" action="/admin/datasiswa/cari" enctype="multipart/form-data">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- Data Anggota -->
          <li class="nav-item">
            <a href="/admin/datasiswa" class="nav-link active">
            <i class="fas fa-user-friends nav-icon"></i>
              <p>
                Data Siswa
              </p>
  ...
  <!-- Content Wrapper. Contains page content -->
   <div class="content-wrapper">
     ...
     <section class="content">
       <div class="container-fluid">
       <a href="/admin/datasiswa/tambah" class="btn btn-danger">Tambah Siswa</a>
       </br></br>
       <div class="card">
               ...
               <tbody>
                 ...
                 <tr>
                   ...
                   <td>{{ $ang->jk }}</td>
                   <td>{{ $ang->kelas }}</td>
                   <td>{{ $ang->tahunajaran }}</td>
                   <td>
                     <a href="/admin/datasiswa/edit/{{ $ang->id }}" class="btn btn-warning" style="width:100%;">Edit</a>
                     <a href="/admin/datasiswa/hapus/{{ $ang->id }}" class="btn btn-danger" style="width:100%;">Hapus</a>
                   </td>
                 </tr>
                 @endforeach
               </tbody>
