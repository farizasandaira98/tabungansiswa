...
<head>
  ...
  <title>Admin Sistem Tabungan Siswa | Data Transaksi Penarikan</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- SEARCH FORM -->
   <form class="form-inline ml-3" method="get" action="/admin/transaksipenarikan/cari" enctype="multipart/form-data">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              ...
              <li class="nav-item">
                <a href="/admin/transaksipenarikan" class="nav-link active">
  ...
  <!-- Content Wrapper. Contains page content -->
   <div class="content-wrapper">
         ...
         <div class="row mb-2">
           ...
           <div class="col-sm-6">
             <ol class="breadcrumb float-sm-right">
               ...
               <li class="breadcrumb-item active">Transaksi Penarikan</li>
             </ol>
           </div><!-- /.col -->
         </div><!-- /.row -->
       </div><!-- /.container-fluid -->
     ...
     <section class="content">
       <div class="container-fluid">
       <a href="/admin/transaksipenarikan/tambah" class="btn btn-danger">Tambah Data Penarikan</a>
       </br></br>
       <div class="card">
               ...
               <tbody>
                 @foreach($transaksipenarikan as $ang)
                 <tr>
                  ...
                  <td>{{ $ang->nominal }}</td>
                  <td >
                     <a href="/admin/transaksipenarikan/edit/{{ $ang->id }}" class="btn btn-warning" style="width:100%;">Edit</a>
                     <a href="/admin/transaksipenarikan/hapus/{{ $ang->id }}" class="btn btn-danger" style="width:100%;">Hapus</a>
                   </td>
                 </tr>
                 @endforeach
               </tbody>
